...
STREAM_KEY_TEMPLATE = "chat:{chat_uuid}:messages"
...
class RedisStreamWriter:
    ...
    def __init__(self, chat_uuid):
        self._chat_uuid = chat_uuid
        self._stream_key = STREAM_KEY_TEMPLATE.format(chat_uuid=chat_uuid)
...
class RedisStreamReader:
    ...
    def __init__(self, chat_uuid, last_seq_id=0):
        self._chat_uuid = chat_uuid
        self._stream_key = STREAM_KEY_TEMPLATE.format(chat_uuid=chat_uuid)
        self._redis = redis.Redis.from_url(settings.REDIS_STREAMS_URL)
